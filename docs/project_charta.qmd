...
**Resources:** Data from [data.tg.ch](https://data.tg.ch/explore/dataset/div-la-2/) [5], GeoJSON/TopoJSON boundaries via [swiss-maps (npm)](https://github.com/interactivethings/swiss-maps) [6] based on [swisstopo swissBOUNDARIES3D](https://www.swisstopo.admin.ch/de/landschaftsmodell-swissboundaries3d) [7], D3.js or Leaflet, GitHub hosting.
