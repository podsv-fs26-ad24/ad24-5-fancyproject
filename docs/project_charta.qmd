...
- Data Literacy: Moderate (understands statistics but is not a data analyst).
...
- Social: Creating a factual basis for discussions with colleagues or the farmers' association.

- Emotional: Feeling confident and objectively informed about regional agricultural developments.

**Pains:**

- Having to sift through dry PDF reports from the canton just to find a single figure.
...
- Data Literacy: High (experienced in interpreting graphics for news articles).
...
- Emotional: Gaining certainty that the cited figures originate from a reliable source (Open Data Thurgau).
...
gantt
    ...
    section Project Understanding
        Charta & Setup                        :done,   a1, 2026-03-19, 2d

    section Data Acquisition
        Data Acquisition & Inspection         :active, a2, after a1,   2d
        Data Cleaning & Joining               :        a3, after a2,   3d
        Exploratory Data Analysis             :        a4, after a3,   4d

    section Design & Encoding
        Choropleth Map (GeoJSON)              :crit,   a5, after a4,   6d
        Colour Scale & Legend                 :        a6, after a5,   2d
        Filter UI & Tooltips                  :        a7, after a5,   4d
        Layout & Responsiveness               :        a8, after a7,   2d

    section Evaluation
        User Testing & Feedback               :        a9, after a8,   3d
        Documentation & Deployment            :crit,   a10, after a9,  5d
```
