...
The target users of this visualization range from domain experts with deep agricultural knowledge to casual users seeking quick data-driven insights. Two representative personas were developed to guide design decisions (see Section 1.5).
...
|---|---|---|---|
| Tim Badertscher | Project Lead & Data Engineering | Project coordination, timeline management, data acquisition from data.tg.ch, data cleaning and merging of statistical and geodata sources | tim.badertscher@students.zhaw.ch |
| Christian Haag | Visualization & Frontend Development | D3.js choropleth implementation, interactive UI components (tooltips, filters, legend), responsive layout, GitHub Pages deployment | christian.haag@students.zhaw.ch |
| Nikola Kroupar | UX Design & Documentation | Persona development, user testing, Quarto documentation (Project Charta, Data Report, Visualization Report), presentation design | nikola.kroupar@students.zhaw.ch |
 
**Project Coaches:**
 
| Name | Role | Contact |
|---|---|---|
| Manuel Dömer | Coach | manuel.doemer@zhaw.ch |
| Wibke Weber | Coach | wibke.weber@zhaw.ch |
